"""
Django settings for fishpost project.
...
# Configure so local static/media files are used in debug mode
...
WSGI_APPLICATION = 'fishpost.wsgi.application'
